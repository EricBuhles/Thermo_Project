...
wav1[1] = 2;                                //0V - 2.5V amplitude (Max amplitude + offset) value must not exceed the „maxOutputScale“
...

{
  ...
  temp_map = mapf(temp*10, 220, 400, 30, 90);
  Serial.println(temp);
  ...
  }               //this is to give the micro time to set the „voltage“
}
